  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : <b>${total}</b>건 - ${page}/ ${totpage} Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
	...
	<c:forEach var="board" items="${list}">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a href="Board?command=board_view&idx=${board.idx}&page=${page}">${board.subject}</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${board.name}</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${board.regdate.substring(2,10)}</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="#" onClick="kensaku()"><img src="Board/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
