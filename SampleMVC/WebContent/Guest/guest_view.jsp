...
<%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 //-->
 	function del(){
 		alert("삭제하시겠습니까?");
 		location.href("Guest?command=guest_delete&idx=${vo.idx}");
 	}	
 </script>
 </head>
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 목록보기 -->
       <a href="Guest?command=guest_list"><img src="Guest/img/list-2.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 수정하기 -->
       <a href="Guest?command=guest_modify&idx=${vo.idx}"><img src="Guest/img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 삭제하기 -->
