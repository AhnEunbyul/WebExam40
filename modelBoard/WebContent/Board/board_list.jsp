...
%>
        ...
        <font face="돋움" size="2" color="#000000"><%= list.get(i).getIdx() %></font></td>
			<td align="left" height="20">&nbsp;
				...
				<td align="center" height="20"><font face="돋움" size="2"><%= list.get(i).getRegdate().substring(2,10) %></font></td>
				<td align="center" height="20"><font face="돋움" size="2">
...
<% }; %>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="25">
        <font face="돋움" size="2" color="#000000">1</font></td>
			<td align="left" height="20">&nbsp;
				<img src="./img/reply2.gif">
				<font face="돋움" size="2" color="#000000">
				<a class="list" href="">반가워요</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">곰돌</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">20-02-27</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				2</font></td>
			</tr>
