 ...
 <table border="0" cellspacing="2" bgcolor="#ecf1ef" width="900" bordercolordark="#ffffff" bordercolorlight="#000000">
   <tr>
     <td width="20%" rowspan="4" valign="bottom" bgcolor="#000000">
       <a href="/Sample/index.jsp"><img src="include/img/ceo.jpg" width="158" height="83" border="0"></a>
	 ...
	 <%
		if(user == null){
	 %>  
     <p align="center"><font color="white" size="2"><b><a href="login.do" class="white">로그인</A></b></font></p>
     <% }else if(user != null){ %>    
     ...
     <p align="center"><font color="white" size="2"><b><a href="insert.do" class="white">회원가입</a></b></font></p>
