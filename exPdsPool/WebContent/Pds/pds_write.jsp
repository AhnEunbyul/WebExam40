...
<!--     다음에 추가할 로그인  -->
   ...
   <td width="80%" valign="top">&nbsp;<br>
	...
	<form name ="pds" method ="post" action="write.do" encType="multipart/form-data">
	  <table border="0" >
		<tr>
       ...
       <tr>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			...
			<a href="javascript:reset()"><img src="Pds/img/purple_cancle.gif" width="56" height="18" border="0"></a>
		  </td> 
        </tr>
      </table>
      </form>
