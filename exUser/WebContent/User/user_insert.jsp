...
<script>
	function emailCheck(){
		alert("인증 메시지를 보냈습니다.");
		window.open("User/emailCodeJSP.jsp","이메일 인증")
		window.open("http://www.naver.com","네이버창 띄우기")
	}
	function send(){
		alert("회원가입이 완료되었습니다.");
		insertForm.submit();
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="User/img/title1.gif" ><br>    
	<form name=insertForm method=post action="user_insert">
					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							<tr bgcolor=#7AAAD5>
								...
								<td align=center></td>
								<td valign=bottom>
									<img src="User/img/u_b05.gif" align=right hspace=0 vspace=0 border=0></a>
								</td>
							</tr>
							<tr bgcolor=#ffffff>
								<td colspan=3 align=center>
									<a href="javascript:send()"><img src="User/img/u_bt06.gif" vspace=3 border=0 name=img3></a>
									<a href="javascript:reset()"><img src="User/img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4></a>
								</td>
							</tr>
						</table> 
					</td>
