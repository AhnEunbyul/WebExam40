...
<div class="contain">
	...
	<form name="my" method="post" action="ui3" enctype="multipart/form-data" onSubmit="return formcheck();">
			...
			<tbody>
					...
					<tr>
						<td colspan="2">
							...
							<input type="button" value="목록"  class="btn-reset" onclick="javascript:location.href='ui?command=ui_index'">
						</td>
					</tr>
