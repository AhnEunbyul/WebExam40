...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name=form_name method=post action="userinfo_insert_view.jsp">
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <a href="javascript:send()"><img src="./img/u_bt06.gif" vspace=3 border=0 name=img3 onclick ="submit"></a>
