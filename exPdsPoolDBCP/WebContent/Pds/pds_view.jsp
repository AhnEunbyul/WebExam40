...
<!--  로그인 폼 추가 -->
  ...
  <tr>  
    ...
    <p>${vo.contents}</p>
    <img src="Pds/img/disk.gif" align="middle" width="22" height="20" border="0">&nbsp;<a href="upload/${vo.filename}" download>${vo.filename}</a>
	
	</font></td></tr>
  </table>
  <p align="center">
  <font size="2">
  <a href="modify.do?idx=${vo.idx}"><img src="Pds/img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="javascript:pds_del()"><img src="Pds/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="list.do"><img src="Pds/img/list-2.gif" border="0"></a></font></td></tr>  
</table>  
</body>  
</html>
