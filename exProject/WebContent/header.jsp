		...
		<header class="header">
			...
			<nav class="top_right">
				<ul>
					...
					%>
						<li class="first"><a href="MemberLogout">로그아웃</a></li>
					<% }else if(session.getValue("user") == null){ %>
						<li class="first"><a href="MemberLogin">로그인</a></li>
			...
			<div class="gnb_group">
				<h1 class="logo"><a href="index"><img src="images/jsl_logo.png" alt="JSL로고" class ="logoimg"></a></h1>
				<nav class="gnb">
					<ul class="nav_1depth">
