...
<form name="member2" method="post" action="userlogin_ok">
     ...
     <tr>
       ...
       <td><input type="image" src="include/img/login1.gif" border="0" onSumbit="return check_login()"></td>

			 <td><a href="userinfo_insert2"><img src="include/img/regist.gif" border="0"></a></td>
