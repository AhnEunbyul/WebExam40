...
<%
	...
	// 조회수 업데이트
	String sql1 = "UPDATE TBL_GUEST SET READCNT=READCNT+1 WHERE IDX=?";
   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       ...
       <a href="guest_modify_pro.jsp"><img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="guest_list.jsp"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
