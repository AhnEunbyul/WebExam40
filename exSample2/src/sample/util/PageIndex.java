		...
		idx_pre = ((page-1) / 10);              // Priview 페이지 계산
	  	...
	  	if(idx_pre > 0) {
	  		s_pre = "<a href='"+url+"&page="+(idx_pre*10)+addtag+"'>"
	  				+ "<img src=portfolio/img/i_prev.gif width=30 height=7></a>";
	  	} else {
	  		s_pre = "<img src=portfolio/img/i_prev.gif width=30 height=7> ";
	  	}
		...
		// Next 표시부분
	  	if(idx_start <= totpage ) {
	  		s_next = "<a href='"+url+"&page="+idx_start+addtag+"'>"
	  				+ "<img src=portfolio/img/i_next.gif width=30 height=7></a>";
	  	} else {
	  		s_next = " <img src=portfolio/img/i_next.gif width=30 height=7>";
	  	}
