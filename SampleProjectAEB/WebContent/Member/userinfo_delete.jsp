						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									...
									<input type=text name=name size=16 maxlength=20 value="${vo2.name }" readonly>성명은 빈칸없이 입력하세요.
									...
									<table cellspacing=0 cellpadding=0>
										...
										<tr>
											...
											<td align=absmiddle>
												...
												<input type=text name=userid size=12 maxlength=16 value="${vo2.userid }" style="width:120" readonly>
							...
							<tr>
                				...
                				<TD BGCOLOR=WHITE>
                  					...
                  					<input type=text name=tel size=13 maxlength=13 value="${vo2.tel }" readonly>
              				...
              				<tr>
                				...
                				<td bgcolor=WHITE valign=middle>
                  					...
                  					<input type=text name=email size=30 maxlength=30 value="${vo2.email }" readonly>
