...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="Member/img/title1.gif" ><br>    
	<form name=form_name method=post action="userinfo_modify.jsp">
				...
				<tr>
					<td bgcolor="#7AAAD5">            
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							<tr bgcolor=#7AAAD5>
								...
								<td align=center bgcolor="#7AAAD5"><FONT COLOR="#FFFFFF"><b>사용자 정보 수정&nbsp;</b><font color=black>(</font><font color=red>&nbsp;*&nbsp;</font><font color=black>표시항목은 반드시 입력하십시요.)</font></FONT></td>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=radio name=gubun value = "직장" <% if(gubun.equals("직장")){%> checked <% } %>>직장&nbsp;&nbsp;
									<input type=radio name=gubun value = "자택" <% if(gubun.equals("자택")){%> checked <% } %>>자택 
								</td>
							</tr>
