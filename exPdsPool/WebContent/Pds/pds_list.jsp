...
<c:forEach items="${list}" var="pds">
	<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="25">
        <font face="돋움" size="2" color="#000000">${pds.idx}</font></td>
		<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="view.do?idx=${pds.idx}">${pds.subject}</font></a></td>
		...
		<td align="left" height="20"><font face="돋움" size="2">${pds.regdate.substring(2,10)}</font></td>
...
<c:if test="${totcount==0}">
   ...
   <tr>
      <td colspan="7" align="right">
				<a href="write.do"><img src="Pds/img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
