...
<html>
<head><title>친목장에 오신것을 환영합니다 ^ㅁ^</title>
...
<table border="0" width="800">
  <tr>
    <td width="20%" height="500" valign="top" bgcolor="#B7F0B1">
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      <tr>
        ...
        <font size="4" face="돋움" color="black">
        <img src="./img/bullet-01.gif"> <b>친 목 장</b></font></td></tr>
      <tr>
...
<%
	while(rs.next()) {
%>
		<tr onMouseOver="style.backgroundColor='#86E57F'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="25">
        <font face="돋움" size="2" color="#000000"><%= rs.getInt("idx") %></font></td>
			<td align="left" height="20">&nbsp;
				<font face="돋움" size="2" color="#000000">
				<a class="list" href=""><%= rs.getString("subject") %></a></td>
